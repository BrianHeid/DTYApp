...
Meteor.methods({
	...
	getDatetimeRequested: function(id){
		console.log("inside: " + Requests.find({patientId:id}).fetch()[0].times.requestTime);
		return Requests.find({patientId:id}).fetch()[0].times.requestTime;
	},
